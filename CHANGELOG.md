...
New Image mode built on ComfyUI-MiniMax-H3-Studio. Text to image, edit a source image, or mix up to 9 references with @Image1 style roles. Custom sampling settings for steps, sampler and scheduler. Images show up everywhere videos do.
