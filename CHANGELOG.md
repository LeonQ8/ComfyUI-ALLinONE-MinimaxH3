...
- Fixed the Support button in the node UI — it was a placeholder URL, now links to the real Ko-fi page (shipped with 0.1.2, unpublished; rolled into this release).
- README: added status/license badges and a beta note, updated screenshots and requirements links (same as above).
